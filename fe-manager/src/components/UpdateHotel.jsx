...
import { createHotel, getHotelDetails, updateHotel } from '../services/apiServices';
...
const HotelUpdateForm = () => {
  ...
  useEffect(() => {
    const fetchHotelDetails = async () => {
      const hotelData = await getHotelDetails(name); // Get data from backend
      setFormData({
        name_hotel: hotelData.name_hotel,
        address: hotelData.address,
        city: hotelData.city,
        country: hotelData.country,
        phone_number: hotelData.phone_number,
        room_quantity: hotelData.room_quantity.toString(),
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await updateHotel(name,{...updatedFormData });
