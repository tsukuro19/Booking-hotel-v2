    ...
    return (
        <div className="flex container mx-auto max-w-[84rem]">
            ...
            <div className="container mx-auto max-w-[50rem] p-8 ml-4">
                ...
                <div className="pb-4">
                    <h1 className="text-3xl font-semibold">Adaaran Club Rannalhi, Maldives, Water Bungalows</h1>
                ...
                <div className="mt-6 py-3 flex-wrap">
                    <div className="flex items-center space-x-2 w-full"> {/* Adjust width for larger screens */}
