...
const PopularDestinations = () => {
    ...
    return (
        <div className="bg-white py-10">
            ...
            <div className="container mx-auto max-w-[90rem] flex flex-wrap justify-center gap-6 px-6 mt-8"> {/* Đảm bảo chiều rộng ở đây */}
                {/* First Row with 2 items */}
                <div className="flex justify-center w-full">
                    <div className="flex flex-1 max-w-[39rem] rounded overflow-hidden shadow-lg bg-white transition-transform transform hover:scale-105">
                        <img
                ...
                <div className="flex justify-center w-full">
                    {destinations.slice(2).map((destination, index) => (
                        <div
                            key={index}
                            className="flex flex-1 max-w-[25.5rem] rounded overflow-hidden shadow-lg bg-white transition-transform transform hover:scale-105 mx-3"
                        >
                            <img
